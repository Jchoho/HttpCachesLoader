...
@implementation FMDatabaseQueue (Tools)
...
-(NSArray *)selectFromTable:(NSString *)tableName{
    ...
    [self inDatabase:^(FMDatabase *db) {
        FMResultSet *resultTableInfo = [db executeQuery:sqlTableInfo];
        ...
        FMResultSet *resultSelect = [db executeQuery:sqlSelect];
